    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-2xl border border-cardBorder shadow-sm overflow-hidden hover-lift">
            ...
            <ul class="divide-y divide-slate-100">
                <li>
                    <a href="<?php echo $base_url; ?>/index.php" class="flex items-center justify-between px-5 py-3.5 hover:bg-secondary transition-colors group">
                        <div class="flex items-center gap-3">
                ...
                <li>
                    <a href="<?php echo $base_url; ?>/laporan.php" class="flex items-center justify-between px-5 py-3.5 hover:bg-secondary transition-colors group">
                        <div class="flex items-center gap-3">
                            <svg class="h-4 w-4 text-slate-400 group-hover:text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="<?php echo $base_url; ?>/grafik.php" class="flex items-center justify-between px-5 py-3.5 hover:bg-secondary transition-colors group">
                        <div class="flex items-center gap-3">
                            <svg class="h-4 w-4 text-slate-400 group-hover:text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="<?php echo $base_url; ?>/login.php" class="flex items-center justify-between px-5 py-3.5 hover:bg-secondary transition-colors group">
                        <div class="flex items-center gap-3">
                            <svg class="h-4 w-4 text-slate-400 group-hover:text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="bg-white rounded-2xl border border-cardBorder shadow-sm overflow-hidden hover-lift">
            ...
            <ul class="divide-y divide-slate-100">
                <li>
                    <a href="<?php echo $base_url; ?>/kontak.php" class="flex items-center justify-between px-5 py-3.5 hover:bg-secondary transition-colors group">
                        <div class="flex items-center gap-3">
                            <svg class="h-4 w-4 text-slate-400 group-hover:text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="<?php echo $base_url; ?>/syarat-ketentuan.php" class="flex items-center justify-between px-5 py-3.5 hover:bg-secondary transition-colors group">
                        <div class="flex items-center gap-3">
                            <svg class="h-4 w-4 text-slate-400 group-hover:text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="<?php echo $base_url; ?>/peta-situs.php" class="flex items-center justify-between px-5 py-3.5 hover:bg-secondary transition-colors group">
                        <div class="flex items-center gap-3">
                            <svg class="h-4 w-4 text-slate-400 group-hover:text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                            </svg>
