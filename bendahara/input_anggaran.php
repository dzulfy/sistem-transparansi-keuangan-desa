...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $jumlah_anggaran = floatval(str_replace('.', '', $_POST['jumlah_anggaran']));
    ...
    <form action="input_anggaran.php" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="jumlah_anggaran" required class="w-full pl-12 border-slate-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary p-2.5 border" placeholder="0" inputmode="numeric" pattern="[0-9.]*">
            </div>
        </div>
        <div>
