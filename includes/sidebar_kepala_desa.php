<?php
// includes/sidebar_kepala_desa.php
...
<head>
    ...
    <title>Dashboard Kepala Desa - STKD</title>
...
<aside class="w-64 bg-white border-r border-slate-200 flex flex-col flex-shrink-0">
    ...
    <div class="flex-1 overflow-y-auto py-4">
        <nav class="px-3 space-y-1">
            ...
            <a href="validasi_anggaran.php" class="<?php echo $current_page == 'validasi_anggaran.php' ? 'bg-primary text-white' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'; ?> group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                <i data-lucide="check-square" class="<?php echo $current_page == 'validasi_anggaran.php' ? 'text-white' : 'text-slate-400 group-hover:text-slate-500'; ?> mr-3 flex-shrink-0 h-5 w-5"></i>
                Validasi Anggaran
            </a>
            <a href="validasi_realisasi.php" class="<?php echo $current_page == 'validasi_realisasi.php' ? 'bg-primary text-white' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'; ?> group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                <i data-lucide="wallet" class="<?php echo $current_page == 'validasi_realisasi.php' ? 'text-white' : 'text-slate-400 group-hover:text-slate-500'; ?> mr-3 flex-shrink-0 h-5 w-5"></i>
                Validasi Realisasi
            </a>
            <a href="monitoring_laporan.php" class="<?php echo $current_page == 'monitoring_laporan.php' ? 'bg-primary text-white' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'; ?> group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                <i data-lucide="bar-chart-3" class="<?php echo $current_page == 'monitoring_laporan.php' ? 'text-white' : 'text-slate-400 group-hover:text-slate-500'; ?> mr-3 flex-shrink-0 h-5 w-5"></i>
                Monitoring Laporan
            </a>
        </nav>
    </div>
